...
from tvm.relay.transform.quantize import Quantizer, QuantizationCalibrator, GlobalCalibrator, DatasetManager
...
calibrator = QuantizationCalibrator(quantizer, target='llvm', ctx=tvm.cpu())
