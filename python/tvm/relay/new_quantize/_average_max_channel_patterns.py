...
from tvm.relay.new_quantize import Conv2DPattern, Conv2DBiasAddPattern, DensePattern, PerChannelPattern, CalibrationCallback, QuantizerPattern, DatasetManager
