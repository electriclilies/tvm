...
def create_q_conv2d_func(data, weight, weight_shape, attrs):
    ...
    data_scale_var, data_zp_var, weight_scale_var, weight_zp_var = create_scale_zps("conv2d_data", "conv2d_weight")
...
def create_conv2d_bias_func(data_shape, weight_shape, bias_shape, attrs):
    data = relay.var("data", relay.TensorType(data_shape, "float32"))
    weight = relay.var("weight", relay.TensorType(weight_shape, "float32"))
...
def create_q_conv2d_bias_func(data, weight, bias, weight_shape, attrs):
...
def test_conv2d_bias(data_shape, weight_shape, bias_shape, attrs): 
    pre_func, data, weight, bias = create_conv2d_bias_func(data_shape, weight_shape, bias_shape, attrs)
    quantized_func = create_q_conv2d_bias_func(data, weight, bias, weight_shape, attrs)
...
def create_q_dense_func(data, weight, attrs):
    data_scale_var, data_zp_var, weight_scale_var, weight_zp_var = create_scale_zps("dense_data", "dense_weight")
