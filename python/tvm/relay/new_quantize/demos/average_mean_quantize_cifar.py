...
from tvm.relay.new_quantize import Quantizer, AverageMeanCalibrater, DatasetManager
...
batch_size = 200
train_dataset_manager = NumpyDatasetManager(train_images, np.ndarray.flatten(train_labels), batch_size)
test_dataset_manager = NumpyDatasetManager(test_images, np.ndarray.flatten(test_labels), batch_size)
